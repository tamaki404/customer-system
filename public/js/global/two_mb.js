document.addEventListener('DOMContentLoaded', function(){
    ...
    var profilePicInput = document.querySelector(
        '.input-forms input[type="file"][name="image"], .modal-option-groups input[type="file"][name="image"], .form-group input[type="file"][name="image"], .input-forms input[type="file"][name="image"]'
    );
