    ...
    <div class="log-form-bg">
        ...
        <div class="form-container" style="display: flex; flex-direction: row; gap: 10px; align-items: center; justify-content: center;">
            ...
            <form method="POST" action="{{ route('registration.supplier.register') }}" class="log-form" id="registerForm" enctype="multipart/form-data">
                        ...
                        <section class="company-details">
                            ...
                            <div class="form-items">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="checkbox" id="option1" name="choices" value="use_default"> 
                ...
                <div class="step2" style="gap: 20px; ">
                    ...
                    <!-- ID details -->
                    <div class="file-upload-container" style="display: flex; flex-direction: row;">

                        <div class="file-upload-section">
                            <label for="sec"> <span class="req-asterisk">*</span> Securities and Exchange Commission (SEC) </label>
                            <input type="file" name="SEC" id="sec" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>
                        <div class="file-upload-section">
                            <label for="bp"> <span class="req-asterisk">*</span> Business permit </label>
                            <input type="file" name="BP" id="bp" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>
                        <div class="file-upload-section">
                            <label for="bir"> <span class="req-asterisk">*</span> BIR form 2303 </label>
                            <input type="file" name="BIR" id="bir" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>
                        <div class="file-upload-section">
                            <label for="mp"> <span class="req-asterisk">*</span> Mayor's permit </label>
                            <input type="file" name="MP" id="bir" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>
                        <div class="file-upload-section">
                            <label for="id"> <span class="req-asterisk">*</span> Valid ID (2)</label>
                            <input type="file" name="valid_one" id="id" required accept="application/pdf">
                            <input type="file" name="valid_two" id="bir" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>
                        <div class="file-upload-section">
                            <label for="bs"> <span class="req-asterisk">*</span> Bank statement (min. 6 months) </label>
                            <input type="file" name="BS" id="bs" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>          
                        <div class="file-upload-section">
                            <label for="pb"> <span class="req-asterisk">*</span> Proof of billing </label>
                            <input type="file" name="PB" id="pb" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>         
                        <div class="file-upload-section">
                            <label for="ncc"> <span class="req-asterisk">*</span> Notarized corporation certificate (CORP) </label>
                            <input type="file" name="NCC" id="ncc" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>        
                        <div class="file-upload-section">
                            <label for="aib"> <span class="req-asterisk">*</span> Articles of incorporation and bylaws (CORP) </label>
                            <input type="file" name="AIB" id="aib" required accept="application/pdf">
                            <p class="error-message"></p>
                        </div>
                    </div>
