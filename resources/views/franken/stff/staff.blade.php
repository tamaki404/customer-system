   ...
   <div class="content-bg" >
        <div class="content-header">
            <div class="contents-display">
                <p>
                    <a href="{{ route('stff.list') }}">< Staffs list</a>
                </p>
            </div>
        ...
        <div class="content-body" style="padding: 10px; border: none; height: auto;">
            <div class="profile-upper">
                ...
                @endphp
                <img class="customer-image" src="{{ $imgSrc }}" alt="Profile Image"> <br>
                            ...
                            <table style="width:100%; border-collapse:collapse; border: 1px solid #f7f7fa;">
                                ...
                                <tbody>
                                    @if ($customers->isEmpty())
                                        <tr>
                                            <td colspan="6" style="text-align: center; padding: 10px; color: #666;">No customers assigned.</td>
                                        </tr>
                                    @else
                                        @foreach($customers as $customer)
                                            <tr>
                                                ...
                                                <td>{{$customer->supp->company_name}}</td>
